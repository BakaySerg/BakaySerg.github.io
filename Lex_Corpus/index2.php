					...
					<div class="row">
						...
						<div class="col-lg-8 offset--1 intro-slider-box">
							<div id="intro-slider" class="intro-slider">
								...
								<!-- <div class="slide"><img src="img/intro-slider/9.jpg" alt="s"></div> -->
								<div class="slide"><img src="img/intro-slider/10.jpg" alt="s"></div>
								<div class="slide"><img src="img/intro-slider/11.jpg" alt="s"></div>
								<!-- <div class="slide"><img src="img/intro-slider/12.jpg" alt="s"></div> -->
								<div class="slide"><img src="img/intro-slider/13.jpg" alt="s"></div>
								<div class="slide"><img src="img/intro-slider/14.jpg" alt="s"></div>
							</div>
						</div>
				...
				<div class="container">
					<div class="any-slider-row">
						<div class="any-slider">
							...
							<div class="slide"><img src="img/industry/01.jpg" alt="a"></div>
							<div class="slide"><img src="img/industry/02.jpg" alt="a"></div>
							<div class="slide"><img src="img/industry/04.jpg" alt="a"></div>
							<div class="slide"><img src="img/industry/03.jpg" alt="a"></div>
							<!-- <div class="slide"><img src="img/industry/05.jpg" alt="a"></div> -->
							<!-- <div class="slide"><img src="img/industry/06.jpg" alt="a"></div> -->
							<div class="slide"><img src="img/industry/07.jpg" alt="a"></div>
							<div class="slide"><img src="img/industry/08.jpg" alt="a"></div>
							<!-- <div class="slide"><img src="img/industry/09.jpg" alt="a"></div> -->
							<!-- <div class="slide"><img src="img/industry/10.jpg" alt="a"></div> -->
							<!-- <div class="slide"><img src="img/industry/11.jpg" alt="a"></div> -->
							<div class="slide"><img src="img/industry/12.jpg" alt="a"></div>
							<!-- <div class="slide"><img src="img/industry/13.jpg" alt="a"></div> -->
							<div class="slide"><img src="img/industry/14.jpg" alt="a"></div>
							<!-- <div class="slide"><img src="img/industry/15.jpg" alt="a"></div> -->
							<div class="slide"><img src="img/industry/16.jpg" alt="a"></div>
							<div class="slide"><img src="img/industry/17.jpg" alt="a"></div>
							<!-- <div class="slide"><img src="img/industry/18.jpg" alt="a"></div> -->
						</div>
					</div>
				</div>
			</section>
