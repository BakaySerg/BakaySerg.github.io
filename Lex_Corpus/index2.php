		...
		<div class="lines">
			...
			<section class="s-intro">
				...
				<div class="intro__decor">
					<i style="background-image: url(img/parallax/lg-left.png)" data-0="transform: translateY(7%)" data-500="transform: translateY(-230%)"></i>
					<i style="background-image: url(img/parallax/md-right.png)" data-0="transform: translateY(6%)" data-500="transform: translateY(-210%)"></i>
					<i style="background-image: url(img/parallax/sm-top.png)" data-0="transform: translateY(1%)" data-500="transform: translateY(-120%)"></i>
					<i style="background-image: url(img/parallax/sm-center.png)" data-0="transform: translateY(1%)" data-500="transform: translateY(-100%)"></i>
					<i style="background-image: url(img/parallax/xs-bottom.png)" data-0="transform: translateY(0%)" data-500="transform: translateY(-30%)"></i>
				</div>					
			</section>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 advant__pict" >
							<img src="img/advant.jpg" alt="hands" data-bottom-top="transform: translateY(8%)" data-top-bottom="transform: translateY(-18%)">
						</div>
