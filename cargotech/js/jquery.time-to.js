    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                data.width = Math.round(data.fontSize * 0.7) || data.width;
                ...
                dot2 = '<span>:</span>';
                maxWidth = Math.round(data.width * 2);
                ...
                if (data.displayDays > 0) {
                    ...
                    thtml = (data.displayCaptions
                        ? '<figure style="width:' + Math.round((data.width * data.displayDays) + 0) + 'px">$1'
                            + '<figcaption style="' + fsStyleVal + 'padding-right:' + 0 + 'px">'
